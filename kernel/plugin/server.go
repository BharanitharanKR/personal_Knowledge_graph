...
type RequestContent struct {
	...
	UserAgent     string `json:"userAgent"`     // e.g. "Sedge/3.6.5 https://b3log.org/siyuan Electron Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Sedge/3.6.5 Chrome/144.0.7559.236 Electron/40.9.1 Safari/537.36"
