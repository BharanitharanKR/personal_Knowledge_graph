...
func (baseInstanceField *BaseInstanceField) GetDateFormat() DateDisplayFormat {
	return baseInstanceField.DateFormat
}
...
type Field interface {
	...
	// GetDateFormat 返回日期字段的显示格式。
	GetDateFormat() DateDisplayFormat
}
