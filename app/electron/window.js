...
const I18N_BASE = {
    "zh-CN": {
        ...
        selectBtn: "选择",
        lang: "🌐 外观语言",
        langDesc: "用户界面语言，后续可以在 <kbd>设置</kbd> - <kbd>外观</kbd> - <kbd>界面</kbd> - <kbd>语言</kbd> 中进行切换",
        feedback: "求助反馈建议",
        community: "用户社区汇总",
        download: "下载最新版",
    ...
    "zh-TW": {
        ...
        selectBtn: "選擇",
        lang: "🌐 外觀語言",
        langDesc: "使用者介面語言，後續可以在 <kbd>設定</kbd> - <kbd>外觀</kbd> - <kbd>介面</kbd> - <kbd>語言</kbd> 中進行切換",
        feedback: "求助回饋建議",
        community: "使用者社群匯總",
        download: "下載最新版",
    ...
    "en": {
        ...
        slogan: "From thought to insight, with agents",
        wsTitle: "Workspaces",
        ...
        selectBtn: "Select",
        lang: "🌐 Language",
        langDesc: "User interface language, which can be switched later in <kbd>Settings</kbd> - <kbd>Appearance</kbd> - <kbd>Interface</kbd> - <kbd>Language</kbd>",
    ...
    "ar": {
        ...
        slogan: "من التفكير إلى البصيرة، مع الوكلاء الأذكياء",
        ...
        selectBtn: "تحديد",
        lang: "🌐 اللغة",
        langDesc: "لغة واجهة المستخدم، يمكن تبديلها لاحقًا في <kbd>الإعدادات</kbd> - <kbd>المظهر</kbd> - <kbd>الواجهة</kbd> - <kbd>اللغة</kbd>",
    ...
    "de": {
        ...
        slogan: "Vom Denken zur Erkenntnis, mit Agenten",
        ...
        selectBtn: "Auswählen",
        lang: "🌐 Sprache",
        langDesc: "Sprache der Benutzeroberfläche, die später in <kbd>Einstellungen</kbd> - <kbd>Erscheinungsbild</kbd> - <kbd>Oberfläche</kbd> - <kbd>Sprache</kbd> gewechselt werden kann",
    ...
    "es": {
        ...
        slogan: "Del pensamiento a la comprensión, con agentes",
        ...
        lang: "🌐 Idioma",
        langDesc: "Idioma de la interfaz de usuario, que se puede cambiar más tarde en <kbd>Configuración</kbd> - <kbd>Apariencia</kbd> - <kbd>Interfaz</kbd> - <kbd>Idioma</kbd>",
    ...
    "fr": {
        ...
        slogan: "De la pensée à la compréhension, avec des agents",
        ...
        lang: "🌐 Langue",
        langDesc: "Langue de l'interface utilisateur, pouvant être modifiée ultérieurement dans <kbd>Paramètres</kbd> - <kbd>Apparence</kbd> - <kbd>Interface</kbd> - <kbd>Langue</kbd>",
    ...
    "he": {
        ...
        slogan: "ממחשבה לתובנה, עם סוכנים חכמים",
        ...
        selectBtn: "בחירה",
        lang: "🌐 שפה",
        langDesc: "שפת ממשק המשתמש, ניתן להחליף מאוחר יותר ב-<kbd>הגדרות</kbd> - <kbd>מראה</kbd> - <kbd>ממשק</kbd> - <kbd>שפה</kbd>",
    ...
    "hi": {
        ...
        slogan: "विचार से अंतर्दृष्टि तक, एजेंटों के साथ",
        wsTitle: "वर्कस्पेस",
        ...
        selectBtn: "चुनें",
        lang: "🌐 भाषा",
        langDesc: "उपयोगकर्ता इंटरफ़ेस भाषा, जिसे बाद में <kbd>सेटिंग्स</kbd> - <kbd>दिखावट</kbd> - <kbd>इंटरफ़ेस</kbd> - <kbd>भाषा</kbd> में बदला जा सकता है",
    ...
    "id": {
        ...
        slogan: "Dari pemikiran menuju wawasan, bersama agen",
        wsTitle: "Ruang Kerja",
        ...
        selectBtn: "Pilih",
        lang: "🌐 Bahasa",
        langDesc: "Bahasa antarmuka pengguna, yang dapat dialihkan nanti di <kbd>Pengaturan</kbd> - <kbd>Penampilan</kbd> - <kbd>Antarmuka</kbd> - <kbd>Bahasa</kbd>",
    ...
    "it": {
        ...
        slogan: "Dal pensiero all'intuizione, insieme agli agenti",
        ...
        selectBtn: "Seleziona",
        lang: "🌐 Lingua",
        langDesc: "Lingua dell'interfaccia utente, che può essere cambiata successivamente in <kbd>Impostazioni</kbd> - <kbd>Aspetto</kbd> - <kbd>Interfaccia</kbd> - <kbd>Lingua</kbd>",
    ...
    "ja": {
        ...
        selectBtn: "選択",
        lang: "🌐 言語",
        langDesc: "ユーザーインターフェースの言語です。後で<kbd>設定</kbd> - <kbd>スタイル</kbd> - <kbd>インターフェース</kbd> - <kbd>言語</kbd>で切り替えることができます",
    ...
    "ko": {
        ...
        selectBtn: "선택",
        lang: "🌐 언어",
        langDesc: "사용자 인터페이스 언어이며, 나중에 <kbd>설정</kbd> - <kbd>모양</kbd> - <kbd>인터페이스</kbd> - <kbd>언어</kbd>에서 전환할 수 있습니다",
        feedback: "지원 및 피드백",
    ...
    "nl": {
        ...
        slogan: "Van denken naar inzicht, met agents",
        wsTitle: "Werkruimten",
        ...
        lang: "🌐 Taal",
        langDesc: "Taal van de gebruikersinterface, die later kan worden gewisseld in <kbd>Instellingen</kbd> - <kbd>Weergave</kbd> - <kbd>Gebruikersinterface</kbd> - <kbd>Taal</kbd>",
    ...
    "pl": {
        ...
        slogan: "Od myślenia do wglądu, z agentami",
        ...
        selectBtn: "Wybierz",
        lang: "🌐 Język",
        langDesc: "Język interfejsu użytkownika, który można później przełączyć w <kbd>Ustawienia</kbd> - <kbd>Wygląd</kbd> - <kbd>Interfejs</kbd> - <kbd>Język</kbd>",
    ...
    "pt-BR": {
        ...
        normalBtn: "Iniciar normalmente",
        slogan: "Do pensamento ao insight, com agentes",
        ...
        lang: "🌐 Idioma",
        langDesc: "Idioma da interface do usuário, que pode ser alterado posteriormente em <kbd>Configurações</kbd> - <kbd>Aparência</kbd> - <kbd>Interface</kbd> - <kbd>Idioma</kbd>",
    ...
    "ru": {
        ...
        slogan: "От мысли к озарению, вместе с агентами",
        ...
        selectBtn: "Выбрать",
        lang: "🌐 Язык",
        langDesc: "Язык интерфейса пользователя, который можно переключить позже в <kbd>Настройки</kbd> - <kbd>Внешний вид</kbd> - <kbd>Интерфейс</kbd> - <kbd>Язык</kbd>",
    ...
    "sk": {
        ...
        slogan: "Od myslenia k poznaniu, s agentmi",
        ...
        selectBtn: "Vybrať",
        lang: "🌐 Jazyk",
        langDesc: "Jazyk používateľského rozhrania, ktorý možno neskôr prepnúť v <kbd>Nastavenia</kbd> - <kbd>Vzhľad</kbd> - <kbd>Rozhranie</kbd> - <kbd>Jazyk</kbd>",
    ...
    "th": {
        ...
        slogan: "จากความคิดสู่ความเข้าใจ ร่วมกับเอเจนต์",
        ...
        selectBtn: "เลือก",
        lang: "🌐 ภาษา",
        langDesc: "ภาษาของอินเทอร์เฟซผู้ใช้ ซึ่งสามารถสลับได้ในภายหลังใน <kbd>ตั้งค่า</kbd> - <kbd>รูปลักษณ์</kbd> - <kbd>อินเทอร์เฟซ</kbd> - <kbd>ภาษา</kbd>",
    ...
    "tr": {
        ...
        slogan: "Düşünceden içgörüye, ajanlarla birlikte",
        ...
        selectBtn: "Seç",
        lang: "🌐 Dil",
        langDesc: "Kullanıcı arayüzü dili, daha sonra <kbd>Ayarlar</kbd> - <kbd>Görünüm</kbd> - <kbd>Arayüz</kbd> - <kbd>Dil</kbd> bölümünde değiştirilebilir",
    ...
    "uk": {
        ...
        slogan: "Від думки до осяяння, разом з агентами",
        ...
        selectBtn: "Вибрати",
        lang: "🌐 Мова",
        langDesc: "Мова інтерфейсу користувача, яку пізніше можна змінити в <kbd>Налаштування</kbd> - <kbd>Вигляд</kbd> - <kbd>Інтерфейс</kbd> - <kbd>Мова</kbd>",
